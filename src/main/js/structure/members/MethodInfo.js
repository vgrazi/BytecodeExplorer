     ...
     this.getBytecode = function (index, constants) {
        ...
        rval +=
            "<table>" +
                ...
                "<tr><td class='access-table-mapped'></td><td class='access-table-desc " + ((accessFlags & 0x0010) != 0?"access-table-bold'":"access-table-dull'") + "'>ACC_FINAL	    </td><td class='access-table-mask'>0x0010</td><td>Declared final; must not be overridden (§5.4.5)." +
